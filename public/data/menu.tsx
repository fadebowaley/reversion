...
export const menus = [
  {
    title: (
      <div className="flex items-center">
        <HomeIcon className="w-5 h-5 mr-2" /> Stay
      </div>
    ),
    url: "/",
  },
  {
    title: (
      <div className="flex items-center">
        <TruckIcon className="w-5 h-5 mr-2" /> Car Rentals
      </div>
    ),
    url: "/cab-listing",
  },

  {
    title: (
      <div className="flex items-center">
        <MapIcon className="w-5 h-5 mr-2" /> Halls
      </div>
    ),
    url: "/property-list",
  },
  {
    title: (
      <div className="flex items-center">
        <ShoppingBagIcon className="w-5 h-5 mr-2" /> Market
      </div>
    ),
    url: "/property-grid",
  },
  {
    title: (
      <div className="flex items-center">
        <CakeIcon className="w-5 h-5 mr-2" /> Food
      </div>
    ),
